...
function Error() {
  ...
  return (
    <div className="fixed z-50 flex w-3/4 h-24 overflow-hidden bg-white shadow-lg max-w-96 rounded-xl left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      <button onClick={()=>router.back()} className="w-16 cursor-pointer focus:outline-none">
        <svg
          className="w-7 h-7"
          fill="none"
          stroke="indianred"
